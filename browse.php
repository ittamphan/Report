...
?>	
	...
	<tr>
		<td align="center"><?php echo $i; ?></td><td><a href="detail.php?id=<?php echo $key ; ?>"><?php echo $rows['name']; ?></a></td><td align="center"><img src="images/<?php echo $rows['image']; ?>" border="0" width="50px"></td><td align="right"><?php echo (float)$rows['price']; ?> VNĐ</td>
		<td align="center">
