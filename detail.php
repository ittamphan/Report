...
<table border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse" width="650px" align="center">
	<tr>
		<td colspan="2"><b>Sản phẩm: <?php echo $data[$id]['name']; ?></b></td>
	...
	<tr>
		...
		<td align="center" width="129"><strong>Giá:</strong> <?php echo (float)$data[$id]['price']; ?> VNĐ</td>
		...
		<input type=hidden name=receiver value="giapluuspkt@gmail.com" /><input type=hidden name=product value="Lập trình mã đơn hàng của bạn vào đây" />
